class Api::V1::S3StoragesController < ApplicationController
  ...
  def s3upload()
    ...
    # #Notes: Full put object shown below, currently uploading full image
    #
    ...
    # Read in image as binary to get the whole thing, then put the image in the bucket.
    File.open('app/assets/images/amazing.jpg', 'rb') do |file|
      @resp = @s3Client.put_object(bucket:'tcnj-csc470-harveyh1', key:'amazing.jpg', body:file)
    end
